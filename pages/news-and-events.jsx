...
const ListingPage = () => {
    ...
    return (
        <>
            <Head>
                <title>News and Events | Univa Education Consultancy</title>
                <meta
                    name="description"
                    content="News and Events at Univa Education Consultancy"
                />
                                ...
                                <div className="info flex-1 md:flex-[5] flex flex-col items-stretch justify-between">
                                    ...
                                    <div className="down">
                                        <div className="info mt-3 flex gap-5">
                                            <div className="time flex items-center gap-2  rounded-md bg-red-100 text-red-800 px-5 py-3">
